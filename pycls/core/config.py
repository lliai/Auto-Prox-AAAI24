...
# -------------------------------- Search options ------------------------------- #
_C.PROXY_DATASET = None

# -------------------------------- Rank options ------------------------------- #
_C.AUTO_PROX = CfgNode()
_C.AUTO_PROX.type = None
_C.AUTO_PROX.input_geno = None
_C.AUTO_PROX.op_geno = None
_C.AUTO_PROX.repr_geno = None
...
_C.AUTOFORMER_SUBNET = CfgNode()
_C.AUTOFORMER_SUBNET.HIDDEN_DIM = None
_C.AUTOFORMER_SUBNET.MLP_RATIO = None
_C.AUTOFORMER_SUBNET.DEPTH = None
_C.AUTOFORMER_SUBNET.NUM_HEADS = None

_C.AUTOFORMER_MODE = "super"
...
_C.PIT_SUBNET = CfgNode()
_C.PIT_SUBNET.BASE_DIM = None
_C.PIT_SUBNET.MLP_RATIO = None
_C.PIT_SUBNET.DEPTH = None
_C.PIT_SUBNET.NUM_HEADS = None
